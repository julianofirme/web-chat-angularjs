...
import { EventParams, EventNames, EventsMap, StrictEventEmitter, DefaultEventsMap } from "socket.io/dist/typed-events";
...
export declare class Socket<ListenEvents extends EventsMap = DefaultEventsMap, EmitEvents extends EventsMap = ListenEvents, ServerSideEvents extends EventsMap = DefaultEventsMap> extends StrictEventEmitter<ListenEvents, EmitEvents, SocketReservedEventsMap> {
